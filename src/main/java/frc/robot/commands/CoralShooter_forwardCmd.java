...
public class CoralShooter_forwardCmd extends Command {
  CoralShooterSubsystem coralShooterSubsystem;
  /** Creates a new CoralSooterCmd. */
  public CoralShooter_forwardCmd(CoralShooterSubsystem coralShooterSubsystem) {
